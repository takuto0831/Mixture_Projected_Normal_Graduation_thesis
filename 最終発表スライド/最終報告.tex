...
本研究では, GroupLens による公開データセットMovieLensの一部分を用いた. MovieLensデータセットは映画評価サイト''movielens.com''において1997年9月から1998年4月までの7ヶ月間の間に集められた943人のユーザ, 1682個の映画についての評価値が記録されている. 評価値について, 0から6までの項目があり, 0は見ていないことを表し, 1から5までの5段階評価で数字が大きいほど高い評価である. コンテンツ情報, ユーザ情報について表\ref{MovieLens1}にまとめる. 
